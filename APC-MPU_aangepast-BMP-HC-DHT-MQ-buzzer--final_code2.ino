...
/* defines variables of BMP280 not necessary when I2C is used
#define BMP_SCK 13
#define BMP_MISO 12
#define BMP_MOSI 11 
#define BMP_CS 10
...
// MQ-135
//###########################################################
// defines variables and constants of MQ-135 
int sensorValue;
...
void setup() {
  ...
  int error;
  uint8_t c;
  Serial.println(F("MPU-6050 Setup"));
  mySerial.println(F("MPU-6050 Setup"));
  ...
  // BMP-280
  Serial.println("BPM-280 setup");
  mySerial.println("BPM-280 setup");
  if (!bmp.begin()) {  
  ...
  // HC-SR04
  Serial.println("HC-SR04 setup");
  mySerial.println("HC-SR04 setup");    
  pinMode(trigPin, OUTPUT); // Sets the trigPin as an Output
  pinMode(echoPin, INPUT); // Sets the echoPin as an Input

  // DHT-11
  Serial.println("DHT-11 setup");
  mySerial.println("DHT-11 setup"); 
  dht.begin();

  // Buzzer module
  Serial.println("Buzzer module setup");
  mySerial.println("Buzzer module setup"); 
...
void loop() {
  // All loop codes go together when creating codes
  unsigned long time;
  time=millis();
  Serial.print(F("Time since start = "));
  Serial.println(time);
  Serial.println();
  mySerial.print(F("Time since start = "));
  ...
  mySerial.println(accel_t_gyro.value.z_accel, DEC);
  // Print the raw gyro values.
  Serial.print(F("gyro x,y,z : "));
  mySerial.print(F("gyro x,y,z : "));
  ...
  mySerial.println(accel_t_gyro.value.z_gyro, DEC);
  ...
  mySerial.println(F(" degrees Celsius"));
  Serial.println(F(""));
  mySerial.println(F(""));

// loop for BMP-280
  Serial.println(F("BMP-280"));
  mySerial.println(F("BMP-280"));
  Serial.print(F("Temperature = "));
  mySerial.print(F("Temperature = "));
  ...
  mySerial.print(bmp.readPressure()/100); //displaying the Pressure in hPa, you can change the unit
  Serial.println(" hPa");
  mySerial.println(" hPa");
  Serial.print(F("Approx altitude = "));
  mySerial.print(F("Approx altitude = "));
  Serial.print(bmp.readAltitude(1019.66)); //The "1019.66" is the pressure(hPa) at sea level in day in your region
  mySerial.print(bmp.readAltitude(1019.66)); //The "1019.66" is the pressure(hPa) at sea level in day in your region
  Serial.println(" m");                    //If you don't know it, modify it until you get your current altitude
  mySerial.println(" m");                    //If you don't know it, modify it until you get your current altitude
  Serial.println();
  mySerial.println();

  //Startcode HC-SR04
  // Clears the trigPin of HC-SR04
  ...
  Serial.println(F("MQ-135"));
  mySerial.println(F("MQ-135"));
  Serial.print("AirQua=");
  mySerial.print("AirQua=");
  Serial.print(sensorValue, DEC);               // prints the value read
  mySerial.print(sensorValue, DEC);               // prints the value read
  Serial.println(" PPM");
